...
public class ClientCustomRepositoryImpl implements ClientCustomRepository {
    ...
    private Client convertResultSetToClient(Object[] resultSet) {
        ...
        String activationCode = (String) resultSet[8];
        Integer age = (Integer) resultSet[9];
        String firstName = (String) resultSet[10];
        String gender = (String) resultSet[11];
        String lastName = (String) resultSet[12];
